...
- Copy the "Course_Registration_Portal" folder and place it inside the root directory of your server. (E.g. : C:\xampp\htdocs\Online-Course-Registration-System)
...
- Open your browser and enter the following URL: 'http://localhost/Online-Course-Registration-System'
